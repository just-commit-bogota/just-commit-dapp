// SLIGHTLY MODIFIED FROM: https://github.com/ensdomains/thorin/blob/main/components/src/components/molecules/CheckboxRow/CheckboxRow.tsx

import * as React from 'react'
import styled, { css } from 'styled-components'
import { CheckSVG, Typography } from '@ensdomains/thorin'

export type Hue = 'blue' | 'green' | 'purple' | 'red' | 'yellow'
...
const uniqueIdCounter = { current: 0 };
    ...
    return (
      <Container $color={color}>
        ...
        <Label htmlFor={id} id="permissions-label">
          ...
          <Content>
            <Typography color={textColor} variant="large">
              {label}
            </Typography>
            {subLabel && (
              <Typography color={textColor} variant="small">
                {subLabel}
              </Typography>
            )}
          </Content>
