...
import {
  ...
  CONTRACT_OWNER,
  ABI,
} from "../contracts/CommitManager.ts";
...
export default function Commit() {
  ...
  const justCommitServices =
    CHALLENGE_COST == "100"
      ? CHALLENGE_COST * 0.09
      : (CHALLENGE_COST * 0.09).toFixed(1);
  const gasCosts =
    CHALLENGE_COST == "100"
      ? CHALLENGE_COST * 0.01
      : (CHALLENGE_COST * 0.01).toFixed(1);
  ...
  const { config: createCommitConfig } = usePrepareContractWrite({
    ...
    args: [
      ...
      {
        value:
          commitAmount == "" ? null : ethers.utils.parseEther(commitAmount),
      },
    ],
  });
  const {
    write: commitWrite,
    data: commitWriteData,
  ...
  async function getWalletMaticBalance() {
    try {
      ...
      setWalletMaticBalance(
        parseFloat(Number(ethers.utils.formatEther(balanceMatic)))
      );
    } catch (err) {
    ...
    <>
      ...
      <div className="container container--flex h-screen items-stretch">
              ...
              <div className="text-center justify-center align-center">
                ...
                {showText && (
                  <Typography
                    ...
                    variant=""
                    weight="small"
                    style={{ lineHeight: "1.4em", fontSize: "0.6em" }}
                  >
                    <br />
        ...
        {loadingState === "loading" && (
          <Placeholders loadingStyle="indexLoadingStyle" number={1} />
        )}
          ...
          >
            ...
            >
                            ...
                            <td className="text-center">
                              {phonePickups === null ? (
                                ...
                                <>
                                  <span>
                                    {"< " +
                                      Math.floor(phonePickups * 0.9 * 0.8)}
                                  </span>{" "}
                                  <span className="text-xs">
                                    <b>(↓20%)</b>
                                  </span>
              ...
              {phonePickups && (
                <div>
                  ...
                  <br />
                  <div
                    className="flex items-center gap-3 justify-center -mt-4 mb-5 hover:cursor-pointer"
                    style={{ direction: "ltr" }}
                  >
                    <a
                      data-tooltip-id="my-tooltip"
                  ...
                  >
                    ...
                    >
                      {"(1 MATIC = "}
                      {formatCurrency(
                        !priceApi.isLoading && formatCurrency(maticPrice, "USD")
                      )}
                      )
                    </div>
                  </div>
            ...
            {!(isWriteLoading || isWaitLoading) &&
              ...
              isCommitButtonEnabled() && (
                <>
                  <div
                    className="flex justify-center text-sm hover:cursor-pointer"
                    style={{ direction: "ltr" }}
                  >
                    <Input
                  ...
                  <ButtonThorin
                    style={{
                      ...
                      marginTop: "2rem",
                      marginBottom: "0rem",
                      backgroundColor: isCommitButtonEnabled()
                        ? "rgb(29 210 151)"
                        : "rgb(29 210 151 / 36%)",
                      borderRadius: 12,
                      color: "white",
                  ...
                  <div className="flex justify-center w-3/10 mt-4">
                    <ButtonThorin
                      ...
                      style={{
                        padding: "20px",
                        backgroundColor: "#1DD297",
                        boxShadow: "0px 2px 2px 1px rgb(0 0 0 / 80%)",
                        borderRadius: "10px",
                      }}
                      outlined
                      shape="rounded"
